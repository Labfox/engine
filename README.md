...
<p align="center">
  <a href="https://godoc.org/github.com/Labfox/engine"><img src="https://godoc.org/github.com/Labfox/engine?status.svg" alt="Godoc"></img></a>
  <a href="https://goreportcard.com/report/github.com/Labfox/engine"><img src="https://goreportcard.com/badge/github.com/Labfox/engine" alt="Go Report Card"/></a>
...
```
git clone https://github.com/Labfox/engine g3n-engine
cd g3n-engine
go install ./...
```
...
import (
	...
	"github.com/Labfox/engine/renderer"
	"github.com/Labfox/engine/util/helper"
...
The complete engine API reference can be found here: [![GoDoc](https://godoc.org/github.com/Labfox/engine?status.svg)](https://godoc.org/github.com/Labfox/engine).

There is also the beginning of a Getting Started Guide, and a newly created list of Guides and Tutorials:

* [Getting Started](https://github.com/Labfox/engine/wiki/Getting-Started-(WIP))
* [Guides and Tutorials](https://github.com/Labfox/engine/wiki/Guides-and-Tutorials)
